...
//
    ...
    struct PinchZoom: UIViewRepresentable {
        ...
        class Coordinator: NSObject, @preconcurrency PinchZoomViewDelgate {
            ...
            @MainActor func pinchZoomView(_: PinchZoomView, didChangePinching isPinching: Bool) {
                pinchZoom.isPinching = isPinching
            }

            @MainActor func pinchZoomView(_: PinchZoomView, didChangeScale scale: CGFloat) {
                pinchZoom.scale = scale
            }

            @MainActor func pinchZoomView(_: PinchZoomView, didChangeAnchor anchor: UnitPoint) {
                pinchZoom.anchor = anchor
            }

            @MainActor func pinchZoomView(_: PinchZoomView, didChangeOffset offset: CGSize) {
